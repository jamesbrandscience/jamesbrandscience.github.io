...
`r fa("download")`[lexical_decision_stimuli.csv](https://drive.google.com/file/d/17l5uVCg7sB-kWZQL7kElxRUXE2Cs67uD/view?usp=drive_link).
...
`r fa("download")` [here](https://drive.google.com/file/d/1XtG8RdAqGV5hGCslfY39WT9tXccE3nEi/view?usp=drive_link), in case you had problems with running the R code.
...
paste0("var stimuli = ",
       toJSON(read_delim("lexical_decision_stimuli.csv"),
              pretty=TRUE),
       ";") %>%
